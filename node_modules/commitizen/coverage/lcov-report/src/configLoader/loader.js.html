...
<html lang="en">
<head>
    <title>Code coverage report for src/configLoader/loader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/configLoader/</a> loader.js
    </h1>
    <div class='clearfix'>
 ...
 */
function loader(configs, config, cwd) <span class="missing-if-branch" title="if path not taken" >I</span>{
    var content;
    var directory = cwd || process.cwd();
&nbsp;
    // If config option is given, attempt to load it
    if (config) {
<span class="cstat-no" title="statement not covered" >        return getContent(config, directory);</span>
    }
&nbsp;
    content = getContent(
        findup(configs, { nocase: true, cwd: directory }, function(configPath) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (path.basename(configPath) === 'package.json') { 
