...
<html lang="en">
<head>
    <title>Code coverage report for src/configLoader/getNormalizedConfig.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/configLoader/</a> getNormalizedConfig.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export default getNormalizedConfig;
&nbsp;
...
&nbsp;
    ...
    if(content.config &amp;&amp; content.config.commitizen) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if(typeof global.it !== 'function')
      {
