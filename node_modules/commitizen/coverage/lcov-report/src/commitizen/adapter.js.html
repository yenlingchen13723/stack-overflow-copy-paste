...
function addPathToAdapterConfig(sh, cliPath, repoPath, adapterNpmName) {
  ...
  let indent = d</span>etectIndent(packageJsonString).indent || <span class="branch-1 cbranch-no" title="branch not covered" >'  ';
 ...
 */
function getNearestNodeModulesDirectory(options) <span class="missing-if-branch" title="else path not taken" >E</span>{
...
<span class="cstat-no" title="statement not covered" >    console.error(`Error: Could not locate node_modules in your project's root directory. Did you forget to npm init or npm install?`)</span>
  }
}
&nbsp;
/**
...
<span class="cstat-no" title="statement not covered" >    throw "Could not find prompter method in the provided adapter module: " + adapterPath;</span>
  }
}
&nbsp;
/**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Mar 10 2016 21:19:14 GMT+0000 (UTC)
</div>
</div>
