...
<html lang="en">
<head>
    <title>Code coverage report for src/commitizen/commit.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/commitizen/</a> commit.js
    </h1>
    <div class='clearfix'>
...
function commit(sh, inquirer, repoPath, prompter, options, done) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if(options.retryLastCommit) {
