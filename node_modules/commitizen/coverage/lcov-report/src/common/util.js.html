...
<html lang="en">
<head>
    <title>Code coverage report for src/common/util.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/common/</a> util.js
    </h1>
    <div class='clearfix'>
 ...
 */
function getParsedJsonFromFile(filePath, fileName, <span class="branch-1 cbranch-no" title="branch not covered" >encoding = <span class="branch-1 cbranch-no" title="branch not covered" ></span>'utf8') </span>{
  try {
