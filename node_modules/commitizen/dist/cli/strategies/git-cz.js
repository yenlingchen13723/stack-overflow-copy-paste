...
var resolveAdapterPath = _commitizen.adapter.resolveAdapterPath;
...
function gitCz(rawGitArgs, environment, adapterConfig) {
  ...
  isClean(process.cwd(), function (stagingIsClean) {
    if (stagingIsClean) {
      ...
      (0, _commitizen.commit)(_shelljs2.default, _inquirer2.default, process.cwd(), prompter, { args: parsedGitCzArgs, disableAppendPaths: true, emitData: true, quiet: false, retryLastCommit: retryLastCommit }, function () {
